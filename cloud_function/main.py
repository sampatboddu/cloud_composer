...
def trigger_dag(data, context=None):
    ...
    # client_id = '82684858095-1uoc8gjelok5fop5rmfucih53fvuo27h.apps.googleusercontent.com'
    client_id = '549083835540-5drr7it5arkrng6s4mhl4dg5th2jjndi.apps.googleusercontent.com'
    # This should be part of your webserver's URL:
    # {tenant-project-id}.appspot.com
    webserver_id = 'af3a6dd298bed3383p-tp'
